...
var title = [
  "1.保護性及祝福的禱告",  "2.幫我們勝過仇敵、心靈釋放的禱告", "3.心靈祝福的禱告", "4.為完成主心意的禱告", "5.榮耀的盼望", "父", "主", "宇宙七奇"
]
var all = [
...
VTList.delegate = {
  ...
  configureTile: function(tile, info) {
    if (info.type == "my-pool") {
      tile.getElementById("text").text = c[info.index].length + c[info.index];//SongPage[info.index].Page + SongPage[info.index].Title;
